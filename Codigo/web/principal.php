...
<html lang="en">
  ...
  <body>
    ...
    <form method="GET" action="informacion.php" class="form-xMonnumento">
  ...
  (function() {
    ...
    btnLi.addEventListener("click", function(){
      formxMonu.remove("form-xMonumento");
      formxMonu.add("form-xMonumento-left");
      formtodo.remove("form-todo");
      formtodo.add("form-todo-left");
      todoInactivo.classList.toggle("todo-activo");
      xMonumento.classList.toggle("xMonumento-inactivo");
    });
})();
</script>
